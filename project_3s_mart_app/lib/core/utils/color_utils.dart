...
class ColorUtils {
  ...
  static const Color primaryRedColor = Color(0xFFEA2027);
  ...
  static Color activeButtonBackgroudColor = const Color(0xFFEA2027).withOpacity(0.1);
  ...
  static const grey = Color(0xFFEFEEEE);
