class Constants {
  ...
  static const String TENDER_DISCCOUNT = "Discount";
...
class PosSettingKey {
  ...
  static const fobStockCountExpiredTime =
      "FOB Stock Count Expired Time - hours";
  static const fobStockCount = "FOB Stock Count";
  static const collectingCustomerData = "Collecting customer data";
  static const collectingCustomerDataReminder =
      "Collect Customer Data Reminder";
  static const sharedSales = "Shared Sales";
  static const changeSaleLocation = "Change Sale Location";
  static const declarationPrintout = "Declaration Printout";
  static const topOff = "Top Off";
  static const raiseGroupToPar = "Raise Group To Par";
  static const orderBySales = "Order By Sales";
  static const fullRaiseToPar = "Full Raise To Par";
  static const endOfDayReport = "End of day report";
  static const refundWithCreditNote = "Refund with credit note";
  static const stockLocationGroupType = 'Stock location group type';
  static const masterOrSales = 'Master/Sales';
  static const printMerchantReceiptCopy  = "Print Merchant Copy";
}

class StockLocationGroupTypeSetting {
  static const fnB = "1";
  static const train = "2";
}
