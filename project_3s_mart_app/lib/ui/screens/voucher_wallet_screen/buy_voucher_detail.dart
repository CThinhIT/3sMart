...
import 'widgets/voucher_detail_widgets/applicable_stores_widget.dart';
...
import 'widgets/voucher_detail_widgets/voucher_gird_list.dart';

class BuyVoucherDetailScreen extends StatelessWidget {
  final VoucherUIModel voucher;
  const BuyVoucherDetailScreen({Key? key, required this.voucher})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                ApplicableStores(stores: voucher.stores),
                const Divider(
                  height: 1,
                  color: ColorUtils.black40,
                ),
      ...
      bottomNavigationBar: ButtonBottom(
        onPressed: () {
          Get.toNamed(MyRouter.voucherPayment, arguments: voucher);
        },
